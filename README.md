...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/tfv_get_tools-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/tfv_get_tools-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add tfv_get_tools
# for installing globally
pixi global install tfv_get_tools
```
...
It is possible to list all of the versions of `tfv_get_tools` available on your platform:
...
```
pixi search tfv_get_tools --channel conda-forge
```
